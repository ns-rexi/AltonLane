    ...
    if (infiniteScrollConfig.enabled) {
        _.extend(FacetsBrowseView.prototype, {
            ...
            loadPage: function loadPage(options) {
                ...
                var itemsContainer;
                if (parseInt(options.pageNumber, 10) >= this.totalPages) {
                    if (!jQuery("#merchend").size()) {
                        this.$el.append(jQuery('<div data-cms-area="item_list_banner_bottom_swatches" data-cms-area-filters="path"></div>'));
