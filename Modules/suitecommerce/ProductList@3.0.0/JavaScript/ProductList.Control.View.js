		...
		)
{
	...
	,	validateGiftCertificate: function validateGiftCertificate (line)
		{
			var line_option_email = line.get('options').findWhere({cartOptionId: 'GIFTCERTRECIPIENTEMAIL'});
	...
	,	getItemOptions: function (line)
		{
			//TODO CHANGE THE FORMAT USED TO PASS OPTIONS TO BE ALIGNED WITH THE REST OF ALL SCA!!!
			//LOT OF EFFORT WAS DONE TO UNIFY THE OPTIONS FORMAT. INSTEAD OF USING VALUE AND DISPLAYVALUE IT SHOULD USE
			//INTERNALID AND  VALUE
			// var result = {};
	...
	,	getProductId: function (line)
		{
			...
			//TODO The following code is old and should be removed when possible
