...
,	[
	...
	,	'OrderWizard.Module.Confirmation.CartSummary'
	...
	,	'OrderWizard.Module.ShowMeasurements'
...
,	function (
	...
	,	OrderWizardModuleConfirmationCartSummary
	...
	,	OrderWizardModuleMeasurements
	,	OrderWizardModuleShowMeasurements
	...
	)
{
	...
	var delivery_method_opc_options = {
		title: _('Shipping Method').translate(),
		is_read_only: false,
		hide_items: true
	};
		...
		},
		{
			...
			}, 
			{
				...
				modules: [
					...
					[OrderWizardModuleRegisterGuest],
					[OrderWizardModuleConfirmationCartSummary, _.extend(_.clone(cart_summary_options), {hideSummaryItems: true, show_promocode_form: false, allow_remove_promocode: false, isConfirmation: true})]
				]
			}]
		}
	];
