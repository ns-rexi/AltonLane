...
<div class="order-wizard-cart-summary-container">
	<h1 class="order-wizard-cart-summary-title">
		{{translate 'Order Confirmed'}}
	</h1>

    <div class="order-wizard-cart-summary-order-info-container">
        {{#if orderNumber}}
            <div class="order-wizard-cart-summary-order-info">Order Number: {{orderNumber}}</div>
        {{/if}}
        <br>
        {{#if orderDate}}
            <div class="order-wizard-cart-summary-order-info">Order Date: {{orderDate}}</div>
        {{/if}}
        {{#if orderName}}
            <div class="order-wizard-cart-summary-order-info">Name: {{orderName}}</div>
        {{/if}}
        {{#if orderEmail}}
            <div class="order-wizard-cart-summary-order-info">Email: {{orderEmail}}</div>
        {{/if}}
        {{#if orderPhone}}
            <div class="order-wizard-cart-summary-order-info">Phone: {{orderPhone}}</div>
        {{/if}}
    </div>

	<div class="order-wizard-confirmation-cart-summary-body">
    ...
    <div class="order-wizard-cart-summary-order-address-container">
        <div class="order-wizard-cart-summary-order-address">
            <div class="order-wizard-cart-summary-order-address-header">
                Bill to:
            </div>
        ...
        <div class="order-wizard-cart-summary-customer-service-container">
            <div class="order-wizard-cart-summary-customer-service-header">
                Customer Service
            </div>
            <div class="order-wizard-cart-summary-customer-service">
                888.800.8616
            </div>
        </div>
    </div>
