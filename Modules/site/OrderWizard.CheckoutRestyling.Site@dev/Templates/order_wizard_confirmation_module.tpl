...
<div class="order-wizard-confirmation-module alert fade in">
	<h2 class="order-wizard-confirmation-module-title">{{translate 'Book An Appointment'}}</h2>
	<div class="order-wizard-confirmation-module-container">
		<div class="order-wizard-confirmation-module-image-container">
			<img class="order-wizard-confirmation-module-image" src="{{imageUrl}}">
		</div>
		<div class="order-wizard-confirmation-module-text-container">
			<div class="order-wizard-confirmation-module-text">
				Thank you. Your transaction is confirmed. 
				<br>
				<br>
				Before we can start making your garment, we need to get you into our showroom to get your measurements. The process takes less than an hour and we'll keep your measurements on file for easier reordering.
			</div>
			<a class="order-wizard-confirmation-module-showroom-button" href="https://www.altonlane.com/showrooms">Book Appointment</a>
		</div>
	</div>
</div>
