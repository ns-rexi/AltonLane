...
<div class="order-wizard-shipmethod-module">
	<div class="order-wizard-module-container">
		<div class="order-wizard-module-head">
			<a class="order-wizard-module-head-toggle collapsed" data-toggle="collapse" data-target="#order-wizard-shipmethod-module-body" aria-expanded="false">
		...
		<div class="order-wizard-module-body collapse" id="order-wizard-shipmethod-module-body" role="tabpanel">
