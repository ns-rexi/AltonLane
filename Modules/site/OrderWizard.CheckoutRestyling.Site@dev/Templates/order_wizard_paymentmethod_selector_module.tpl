...
<div class="order-wizard-paymentmethod-selector-module">
	<div class="order-wizard-module-container">
		<div class="order-wizard-module-head">
			<a class="order-wizard-module-head-toggle collapsed" data-toggle="collapse" data-target="#order-wizard-paymentmethod-selector-module-body" aria-expanded="false">
		...
		<div class="order-wizard-module-body collapse" id="order-wizard-paymentmethod-selector-module-body" role="tabpanel">
			<div class="order-wizard-paymentmethod-selector-module-body-container">
				...
				<div class="order-wizard-next-container">
					<a data-action="next" class="order-wizard-next-button">
						{{translate 'Next'}}
						<i class="order-wizard-next-icon"></i>
					</a>
				</div>
			</div>
		</div>
