...
<div class="order-wizard-address-module">
	<div class="order-wizard-module-container">
		<div class="order-wizard-module-head">
			<a class="order-wizard-module-head-toggle collapsed" data-toggle="collapse" data-target="#order-wizard-address-module-body-{{manageValue}}" aria-expanded="false">
		...
		<div class="order-wizard-module-body collapse" id="order-wizard-address-module-body-{{manageValue}}" role="tabpanel">
			<div class="order-wizard-address-module-body-container">
				{{#if isSameAsEnabled}}
