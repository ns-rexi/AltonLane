...
<div class="order-wizard-paymentmethod-giftcertificates-module">
	<div class="order-wizard-module-container">
		<div class="order-wizard-module-head">
			<a class="order-wizard-module-head-toggle collapsed" data-toggle="collapse" data-target="#order-wizard-paymentmethod-giftcertificates-module-body" aria-expanded="false">
				<h3 class="order-wizard-module-title">
					{{translate 'Gift Certificate'}}
					<i class="order-wizard-module-toggle-icon"></i>
				</h3>
			</a>
		</div>
		<div class="order-wizard-module-body collapse" id="order-wizard-paymentmethod-giftcertificates-module-body" role="tabpanel">
			<div class="order-wizard-module-body-container">
				<form id="gift-certificate-form" class="order-wizard-paymentmethod-giftcertificates-module-form" data-action="gift-certificate-form">
					<div class="order-wizard-paymentmethod-giftcertificates-module-form-container">
						<fieldset>
